<template>
    <div>
        <v-toolbar
            ...
            <v-toolbar-title class="d-none d-lg-block">Admin Area</v-toolbar-title>
            ...
            <v-menu v-model="drawer">
                ...
                <v-list class="elevation-5 rounded-lg" lines="three" style="position:absolute; right:0; height: 300px;" >
